...
[
  ...
  { id: 6, name: 'Breezy Point Apt TN', type: 'WINDOW INSTALL', address: '2801 Raja Dr, Memphis, TN 38127', mapLink: 'https://www.google.com/maps/search/?api=1&query=2801+Raja+Dr+Memphis+TN' },
  { id: 7, name: 'Chickasaw Place Apt', type: 'EXTERIOR PAINT', address: '203 Red Oak Dr E, Memphis, TN 38112', mapLink: 'https://www.google.com/maps/search/?api=1&query=203+Red+Oak+Dr+E+Memphis+TN' },
  { id: 8, name: 'Eastern Hts & Creekwood', type: 'FENCE PRESSURE WASH AND PAINT', address: '281 Johnson Cir W, Memphis, TN 38112', mapLink: 'https://www.google.com/maps/search/?api=1&query=281+Johnson+Cir+W+Memphis+TN' },
  { id: 9, name: 'Graceland Garden Apt', type: 'FULL RENOVATION', address: '1430 Graceland Pines Ln, Memphis, TN 38116', mapLink: 'https://www.google.com/maps/search/?api=1&query=1430+Graceland+Pines+Ln+Memphis+TN' },
  { id: 10, name: 'Greenbriar Apt', type: 'INTERIOR AND EXTERIOR RENOVATION', address: '3131 Madewell St, Memphis, TN 38127', mapLink: 'https://www.google.com/maps/search/?api=1&query=3131+Madewell+St+Memphis+TN' },
  { id: 11, name: 'Highland Meadows Apt', type: 'SIDING INSTALLATION', address: '5001 Airways Blvd, Memphis, TN 38116', mapLink: 'https://www.google.com/maps/search/?api=1&query=5001+Airways+Blvd+Memphis+TN' },
  { id: 12, name: 'IRISH Apt Mcewen TN', type: 'WINDOW INSTALL', address: '43 Irish Dr, McEwen, TN 37101', mapLink: 'https://www.google.com/maps/search/?api=1&query=43+Irish+Dr+McEwen+TN' },
  { id: 13, name: 'Marianna, AR (South Pointe)', type: 'EXTERIOR PAINT', address: '365 California St, Marianna, AR 72360', mapLink: 'https://www.google.com/maps/search/?api=1&query=365+California+St+Marianna+AR' },
  { id: 14, name: 'Parkridge Apt Graham, NC', type: 'FENCE PRESSURE WASH AND PAINT', address: '1013 Town Branch Rd, Graham, NC 27253', mapLink: 'https://www.google.com/maps/search/?api=1&query=1013+Town+Branch+Rd+Graham+NC' },
  { id: 15, name: 'Pershing Park Apt TN', type: 'FULL RENOVATION', address: '3707 Pershing Park Dr, Memphis, TN 38127', mapLink: 'https://www.google.com/maps/search/?api=1&query=3707+Pershing+Park+Dr+Memphis+TN' },
  { id: 16, name: 'Presidential West Apt', type: 'INTERIOR AND EXTERIOR RENOVATION', address: '5459 Hudgins Rd, Memphis, TN 38116', mapLink: 'https://www.google.com/maps/search/?api=1&query=5459+Hudgins+Rd+Memphis+TN' },
  { id: 17, name: 'Riverset Apt', type: 'SIDING INSTALLATION', address: '100 Riverset Ln, Memphis, TN 38103', mapLink: 'https://www.google.com/maps/search/?api=1&query=100+Riverset+Ln+Memphis+TN' },
  { id: 18, name: 'Royal Arms Apt', type: 'WINDOW INSTALL', address: '1580 N Royal St, Jackson, TN 38301', mapLink: 'https://www.google.com/maps/search/?api=1&query=1580+N+Royal+St+Jackson+TN' },
  { id: 19, name: 'South Park Gardens, MS', type: 'EXTERIOR PAINT', address: '8156 S Park Cir, Southaven, MS 38671', mapLink: 'https://www.google.com/maps/search/?api=1&query=8156+S+Park+Cir+Southaven+MS' },
  { id: 20, name: 'Spring Valley Apt', type: 'FENCE PRESSURE WASH AND PAINT', address: '4477 Spring Valley Dr, Memphis, TN 38128', mapLink: 'https://www.google.com/maps/search/?api=1&query=4477+Spring+Valley+Dr+Memphis+TN' },
  { id: 21, name: 'Summit Park', type: 'FULL RENOVATION', address: '1770 Piping Rock Dr, Memphis, TN 38116', mapLink: 'https://www.google.com/maps/search/?api=1&query=1770+Piping+Rock+Dr+Memphis+TN' },
...
export default function Home() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    // SLOW MOTION ANIMATION (1 Second)
    if (activeTab === 'TEAM') {
        let count = 0;
